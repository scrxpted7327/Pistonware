	...
	task.spawn(function()
		pcall(function()
			...
			if not isfile("vape/Profiles/bedwarsdata.txt") then 
				local commit = "main"
				for i,v in next, (game:HttpGet("https://github.com/supercellgamer/Pistonware"):split("\n")) do 
				...
				writefile("vape/Profiles/bedwarsdata.txt", game:HttpGet("https://raw.githubusercontent.com/supercellgamer/Pistonware/"..commit.."/CustomModules/bedwarsdata", true))
			end
			...
			repeat
				...
				local newdata = game:HttpGet("https://raw.githubusercontent.com/supercellgamer/Pistonware/"..commit.."/CustomModules/bedwarsdata", true)
